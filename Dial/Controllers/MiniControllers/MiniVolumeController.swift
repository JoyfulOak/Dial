...
final class MiniVolumeController: Controller {
    static let instance: MiniVolumeController = .init()

    var id: ControllerID = .miniVolume
    var name: String? = String(localized: .init("Controllers/Builtin/MiniVolume: Name",
                                                defaultValue: "MiniVolume"))
